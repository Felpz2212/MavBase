...
class MAV:
    ...
    def set_points(self):
        self.drone_goal_pose.pose.position.x = 2
        self.drone_goal_pose.pose.position.y = 2
        self.drone_goal_pose.pose.position.z = 2
